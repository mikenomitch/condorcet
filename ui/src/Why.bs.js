...
function Why(Props) {
  return React.createElement("div", {
              className: "page"
                  ...
                  className: "centered"
                }, R$Condorcet.s("Why don't we use this in politics?")), React.createElement("p", undefined, R$Condorcet.s("\n        Instant Runoff Elections are actually gaining popularity in American politics!\n        FairVote, FOO, and BAR are all bipartisan organizations (to the extend that is possible)\n        that are encouraging more alternative election schemes in politics.\n        ")), React.createElement("h4", {
                  className: "centered"
                }, R$Condorcet.s("About the site")), React.createElement("p", undefined, R$Condorcet.s("This site was made to be the simplest way to run polls with alternative election schemes.\n          I really enjoy getting ideas or feedback, so feel free to email me at poller(at)mikenomitch(dot)com.")), React.createElement("br", undefined));
}

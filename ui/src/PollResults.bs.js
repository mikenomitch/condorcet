...
function PollResults(Props) {
  ...
  var renderResultsLink = function (param) {
    ...
    if (match !== undefined) {
      return React.createElement("div", {
                ...
                }, React.createElement("p", undefined, React.createElement("b", undefined, R$Condorcet.s("Save this URL to return to results:"))), React.createElement(CopyableLink$Condorcet.make, {
  ...
  if (result.responseCount === 0) {
    return React.createElement("h4", undefined, R$Condorcet.s("No responses yet"));
  } else {
